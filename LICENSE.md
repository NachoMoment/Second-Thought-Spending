...
Second Thought is proprietary software. The source code is made visible for
transparency, security review, personal evaluation, and owner-reviewed
contributions. It is not open-source software and no open-source license is
granted.

## Limited permission

Subject to these terms, an individual developer may:
...
1. Publish, redistribute, sublicense, sell, rent, host, or otherwise provide the
   source code or compiled application to another person or the public.
2. Rebrand the software, create or distribute an independent release, or use it
   to operate a competing product or service.
3. Use Second Thought or its name, logo, design, or other project assets for a
   commercial purpose.
...
for a material violation of these terms.
...
license, sublicense, commercialize, and otherwise exploit that contribution as
part of or in connection with Second Thought.

The contributor retains copyright in their original contribution. Submitting a
contribution does not transfer project ownership, grant repository access,
guarantee acceptance, or require attribution beyond any rights required by
applicable law or separately agreed in writing.
...
PURPOSE, NON-INFRINGEMENT, AVAILABILITY, OR ERROR-FREE OPERATION. TO THE MAXIMUM
